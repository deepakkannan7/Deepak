...
function Review1(){
    return(
        ...
        <div className="comment">
            ...
            <div className="revsubmit">
                <div className="revsubmitwri">
                    <h3>SUBMIT</h3>
                </div>
            </div>        </div>
          <div className="pubreview">
            <div className="pubrev">
                <h1>PUBLIC REVIEW</h1>
            </div>
          <div className="pubrevstr">
                <div className="pubrevrat">
                 <h3>4</h3></div>
                 <div className="prstrimg">
                    <img className="prstr1"/>
                    <img className="prstr2"/>
                    <img className="prstr3"/>
                    <img className="prstr4"/>
                </div>
            </div>
            <div className="pubcomments">
                <div className="pubcom1">
                    <h5>   Here people can delve deep into delicious meals, and order fully
                cooked grilled chicken</h5>
                </div>
                <div className="pubcom2">
